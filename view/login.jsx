    ...
    return (
      <div className='cookiePaster'>
        <div className='cinput'>
          <input type='text' ref={f => (this.input = f)} onChange={evt => this.props.onChange(this.value)} />
        </div>
        <div className='cbutton'>
          <button className='emp' onClick={this.handlePaste}>
            Paste
          </button>
        </div>
      </div>
      ...
      let saveCookieCheckbox = (
        <div className='cSaveCookieCheckbox'>
          <input
            ...
            checked={this.state.saveCheck}
            ref={f => (this.saveCheckInput = f)} />
        ...
        case null:
          midLogin = (
            <div className='mid waitLogin selectMethod'>
              ...
              <button className='yes' onClick={this.handleUseCookie}>
                Yes, use my Cookie!
              </button>
              <button className='no'>
                No, use my login and password.
              </button>
              <div className='other'>
        ...
        case 'cookie':
          ...
          midLogin = (
            <div className='mid waitLogin cookieMethod'>
              <div className='askCookie'>
                Please paste your cookie below:
              </div>
              <CookiePaster onChange={this.handleCookieInput} ref={pasterRef} />
              {saveCookieCheckbox}
              {errmsg}
            </div>
          )
